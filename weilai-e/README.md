...
> 一份 3 天迭代出来的求职陪伴 AI，对应 [`未来鹅_设计方案.md`](../未来鹅_设计方案.md)。
> 「未来鹅」= 你的求职贴心学长，从大一到毕业全程陪伴，覆盖各大主流公司校招，帮你搞清楚"去哪、做什么、怎么准备"。

## 功能一览

- **五角色 Agent + 智能路由**（LangGraph）：反向访谈 / 探索向导 / 实习导航 / 求职教练 / 面试陪练，按年级 + 意图自动切换。
- **成长闭环引擎**：反向访谈沉淀「经历 / 能力 / 纠结」素材卡，跨会话主动追问 pending 任务，能力雷达 6 维 vs 目标岗位要求叠加。
- **RAG 知识库**：内置 5 篇基础文档（17 家主流公司岗位 + 实习/面试/文化），ChromaDB 向量检索,缺依赖时自动降级关键词检索。
